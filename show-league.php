...
?>
<div class="wrap">
	<p class="leaguemanager_breadcrumb"><a href="edit.php?page=leaguemanager/manage-leagues.php"><?php _e( 'Leaguemanager', 'leaguemanager' ) ?></a> > <?php echo $league_title ?></p>
</div>
<div class="wrap">
	...
	<form id="teams-filter" action="" method="post">
		...
		<thead>
		<tr>
			<th scope="col" class="check-column"><input type="checkbox" onclick="checkAll(document.getElementById('teams-filter'));" /></th>
	...
	<form id="competitions-filter" action="" method="post">
		...
		<thead>
		<tr>
			<th scope="col" class="check-column"><input type="checkbox" onclick="checkAll(document.getElementById('competitions-filter'));" /></th>

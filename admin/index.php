...
<!--			<th scope="col"><?php _e( 'Status', 'leaguemanager' ) ?></th>
		...
		<tbody id="the-list">
			...
			<tr class="<?php echo $class ?>">
				...
				<td><a href="admin.php?page=leaguemanager&amp;subpage=show-league&amp;id=<?php echo $league->id ?>"><?php echo $league->title ?></a></td>
				<td class="num"><?php echo $leaguemanager->getNumSeasons( &$league ) ?></td>

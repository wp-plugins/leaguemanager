function addCol() {
   ...
   new_element_contents += "<td  style='text-align: center; width: 12px; vertical-align: middle;'><a class='image_link' href='#' onclick='return removeNewCol(\""+new_element_id+"\");'><img src='../wp-content/plugins/leaguemanager/images/trash.gif' alt='Delete' title='' /></a></td>\n\r";

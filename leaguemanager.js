function leaguemanagerAddCol() {
  ...
  new_element_contents += "<td  style='text-align: center; width: 12px; vertical-align: middle;'><a class='image_link' href='#' onclick='return leaguemanagerRemoveNewCol(\""+new_element_id+"\");'><img src='../wp-content/plugins/leaguemanager/images/trash.gif' alt='Delete' title='' /></a></td>\n\r";
...
function leaguemanagerRemoveNewCol(id) {
...
function leaguemanagerRemoveCol(id,col_id) {
  element_count = document.getElementById("leaguemanager_table_structure").childNodes.length;
  if(element_count > 1) {
    target_element = document.getElementById(id);
    document.getElementById("leaguemanager_table_structure").removeChild(target_element);
...
* Taken from WP 2.5
*/
function leaguemanagerCheckAll(form) {
